...
openstack subnet create external --network external --dhcp --allocation-pool start=10.19.111.130,end=10.19.111.150 --gateway 10.19.111.254 --subnet-range 10.19.111.0/24 --dns-nameserver 10.11.5.19
